  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Information System, your all-in-one platform for seamless management of employee data, vacations, and payroll."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Information System, your all-in-one platform for seamless management of employee data, vacations, and payroll.`}
            </Text>
            <Box
